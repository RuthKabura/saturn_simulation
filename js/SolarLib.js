...
//    ringMesh.receiveShadow = true;
  ...
  function Sun(params = {}) {
    ...
    this.glowSize = !isNaN(params.glowSize) ? params.glowSize : this.glowSize;
    ...
    this.sunUniforms = {
      amplitude:              { value: params.sunUniforms.amplitude || 0 },
      ...
      brightnessMultiplier:   { value: params.sunUniforms.brightnessMultiplier || 0 },
...
//    sunUniforms.texture.wrapS = sunUniforms.texture.wrapT = THREE.RepeatWrapping;
  ...
  */
  ...
  function Orbit(params = {alpha: true}) {
    ...
    this.color        = params.color || 0x000000,0;
